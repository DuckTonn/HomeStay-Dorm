...
const ItemCardS = () => {
  return (
    <article className="w-full max-w-[16rem] shrink-0 flex flex-col rounded-2xl border border-LightOutline bg-white/30 shadow-sm transition-shadow hover:shadow-md be-vietnam-pro-light">
      <div className="relative h-42 w-full p-2">
        <img
          src={roomImage}
      ...
      <div className="flex flex-col gap-2 px-5 pb-4 pt-2">
        ...
        <div className="flex items-center justify-between text">
          <span className="be-vietnam-pro-medium text-size-xs">Trống 2 giường</span>
          <span className="text-size-xs text-text/50">1 ngày trước</span>
        </div>

        {/* Title */}
        <h2 className="text-size-base font-semibold leading-tight text-text">
        ...
        <ul className="mt-1 flex flex-col gap-2 text-size-small text-text">
          ...
          <li className="mt-1 flex items-center gap-2 text-size-small justify-start">
            <img
              src={mapPinIcon}
              alt="Location"
