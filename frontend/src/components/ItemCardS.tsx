...
const ItemCardS = ({ room }: ItemCardSProps) => {
  ...
  return (
    <Link
      to="/room-detail"
      state={{ room }}
      className="w-full max-w-[17rem] shrink-0 flex flex-col rounded-2xl border border-LightOutline bg-white/30 shadow-sm transition-shadow hover:shadow-md be-vietnam-pro-light cursor-pointer block"
    >
